...
export default function Testimonial() {
    ...
    return (
        <section
            className="relative w-full overflow-hidden bg-gray-50 p-4 sm:p-6">
            <div className="mb-3">
            ...
            <div className="overflow-hidden w-full">
                ...
                >
                    ...
                    >
                        {/* First div */}
                        <div
                            className="flex flex-col justifyw-between w-full md:w-1/2">
                            ...
                            <p
                                className=" text-xl mb-4">{t.description}
                            </p>
